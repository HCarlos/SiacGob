...
- (void)loadImageFromURL:(NSURL*)url {
	if (connection!=nil) { [connection finalize]; } //in case we are downloading a 2nd image
	if (data!=nil) { [data finalize]; }
...
- (void)connectionDidFinishLoading:(NSURLConnection*)theConnection {
	...
	[data finalize]; //don't need this any more, its in the UIImageView now
	data=nil;
}
