...
function tablaDeElementos(){
	...
	$.post(obj.getValue(0)+"getEC/", { o:obj.index, t:12, p:3,c:" where idcontrato = "+idcontrato+" "+oBy+orderBy,from:oPag.currentPage, cantidad:oPag.CantidadPagina },
		function(json){
	...
	if(currentItem>-1){
		$(".detFac").find('#tr'+currentItem).each(function(){
			...
			if (confirm("Deseas eliminar este elemento?\n\n"+prod+' '+med)){
				...
				$('#cmdDelFac').hide();
				if (idfacdet>0){
					$.post(obj.getValue(0)+"getEC/", { o:obj.index, t:3, p:2,c:idfacdet },
					function(json){
...
function getRFC(idcli){
	...
	$.post(obj.getValue(0)+"getEC/", { o:obj.index, t:0, p:0, c:'idcliparent='+idcli },
 		function(json){
			if (json.length<=0) { return false;}
...
function getContPAQi(idcli){
	...
	$.post(obj.getValue(0)+"getEC/", { o:obj.index, t:1, p:0, c:'idcli='+idcli },
 		function(json){
			if (json.length<=0) { return false;}
...
function getProdCont(){
	var lbl;
	$.post(obj.getValue(0)+"getEC/", { o:obj.index, t:100, p:0, c:'idcontrato='+idcontrato },
 		function(json){
			if (json.length<=0) { return false;}
...
function buscarFactura(idfactura){
	...
	indiceTabla=0;
	$.post(obj.getValue(0)+"getEC/", { o:obj.index, t:13, p:3, c:' where idfactura='+idfactura },
 		function(json){
