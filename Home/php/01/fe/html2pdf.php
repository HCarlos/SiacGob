...
var $issetcolor;
    ...
    {   
        ...
        $this->Image('imgs/logo_arji.gif',6,8,56);
		...
		$this->Cell(95,4,utf8_decode("COLEGIO ARJÍ, A.C."),0,0,'C');
		...
		$this->SetTextColor(0,0,0);
		$this->Cell(50,4,"",0,0,'C');
		$this->Cell(95,4,utf8_decode("R.F.C. CAR7909222P7"),0,0,'C');
		$this->SetFont('Arial','',8);
		$this->SetTextColor(0,0,0);
		$this->Cell(25,4,"Serie: U",1,0,'C');
		$this->Cell(25,4,"Folio: ".$folio,1,1,'C');
		$this->SetFont('Arial','B',8);
		$this->Cell(50,4,"",0,0,'C');
